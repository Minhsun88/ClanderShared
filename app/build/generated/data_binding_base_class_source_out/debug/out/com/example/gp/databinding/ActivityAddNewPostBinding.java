...
public final class ActivityAddNewPostBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityAddNewPostBinding(@NonNull LinearLayout rootView, @NonNull EditText PostEdText,
  ...
  @NonNull
  public static ActivityAddNewPostBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAddNewPostBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_add_new_post, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAddNewPostBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddNewPostBinding((LinearLayout) rootView, PostEdText, PostImg, addLinear,

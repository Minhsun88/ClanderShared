...
public final class ActivityAddNewNoteBinding implements ViewBinding {
  ...
  private ActivityAddNewNoteBinding(@NonNull LinearLayout rootView, @NonNull Button buttonSave,
  ...
  @NonNull
  public static ActivityAddNewNoteBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAddNewNoteBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_add_new_note, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAddNewNoteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddNewNoteBinding((LinearLayout) rootView, buttonSave, edText, edTitle,
          textViewTitle);
    }
